...
export class Backend implements backendInterface {
    ...
    async getAllSubmissionsByName(): Promise<Array<Submission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSubmissionsByName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSubmissionsByService(arg0: string): Promise<Array<Submission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSubmissionsByService(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeForm(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeForm(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitForm(arg0: string, arg1: string, arg2: string, arg3: Array<string>): Promise<string> {
        if (this.processError) {
            try {
